...
export type UpdateCourseCustomFields = [
  {
    display_name: "Category",
    variable_name: "category",
...
export interface VerifyTransactionResponse extends BasicResponse {
  event: string,
  data: {
    id: number,
    domain: string,
...
export interface UpdateCourseTransactionData {
  id: number,
  domain: string,
  status: string,
  reference: string,
...
export interface UpdateCourseTransaction extends BasicResponse {
  event: string,
  data: UpdateCourseTransactionData
}

export interface UpdateCourseTransactions {
  event: string,
  data: UpdateCourseTransactionData[]
}
